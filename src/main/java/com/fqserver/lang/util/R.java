...
public class R {
    ...
    private static final char[] _UU64 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".toCharArray();
    ...
    public static String UU16(UUID uu) {
        ...
        sb.append(Long.toHexString(uu.getMostSignificantBits()));
        while (sb.length() < 16) {
            sb.append('0');
        }
        sb.append(Long.toHexString(uu.getLeastSignificantBits()));
        while (sb.length() < 32) {
            sb.append('0');
        }
        return sb.toString();
